...
//Example 1
//If mouse pointer is on the left of the screen
//If mouse pointer is on the right of the screen
...
let pointer = this.input.activePointer;
if(pointer.x >= 50 && pointer.x <= 750){ // this line stops it wiobbling at edges when mouse offscreen
    player.x = pointer.x;
}
